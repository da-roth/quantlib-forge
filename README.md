...
═════════════════════════════════════════════════════════════════════════════════════
  Scenarios       XAD               Forge-AAD                      Forge vs XAD
                  (~0.09 ms/eval)   (1.54 ms kernel creation)
───────────────────────────────────────────────────────────────────────────────
          1        0.09 ms           1.58 ms                       0.06×
         10        0.92 ms           1.60 ms                       0.58×
        100        9.28 ms           1.90 ms                       4.9×
      1,000       89.43 ms           4.82 ms                       18.6×
═════════════════════════════════════════════════════════════════════════════════════
```
...
─────────────────────────────────────────────────────────────────────────────────────────────────────────────
  1 (10 RF, 1 step)          1        0.28 ms        0.30 ms          0.38 ms        0.05 ms
                                        (1×)         (0.9×)           (0.7×)            (6×)

  2 (100 RF, 1 step)         1        2.52 ms        0.48 ms          0.56 ms        0.06 ms
                                        (1×)         (5.3×)           (4.5×)           (42×)

  3 (100 RF, 3 steps)        1        5.86 ms        1.26 ms          1.58 ms        0.10 ms
                                        (1×)         (4.7×)           (3.7×)           (59×)

  3 (100 RF, 3 steps)       10       57.60 ms        2.02 ms          1.60 ms        0.99 ms
                                        (1×)          (28×)            (36×)           (58×)

  3 (100 RF, 3 steps)      100      575.20 ms        9.58 ms          1.90 ms        9.28 ms
                                        (1×)          (60×)           (303×)           (62×)

  3 (100 RF, 3 steps)    1,000   5,894.60 ms       80.14 ms          4.82 ms       89.43 ms
                                        (1×)          (74×)         (1,223×)           (66×)
═════════════════════════════════════════════════════════════════════════════════════════════════════════════
```
...
|-------------------------|-----------|-----------------|----------------------|-------------|----------------------|------------|------------|
| 1 (10 RF, 1 step)       | 1         | 0.27            | 0.30                 | 0.01        | 0.38                 | 0.001      | 0.05       |
| 2 (100 RF, 1 step)      | 1         | 2.52            | 0.45                 | 0.03        | 0.56                 | 0.001      | 0.06       |
| 3 (100 RF, 3 steps)     | 1         | 1.96            | 1.17                 | 0.03        | 1.55                 | 0.001      | 0.03       |
| 3 (100 RF, 3 steps)     | 10        | 1.92            | 1.21                 | 0.03        | 1.54                 | 0.001      | 0.03       |
| 3 (100 RF, 3 steps)     | 100       | 1.92            | 1.36                 | 0.03        | 1.59                 | 0.001      | 0.03       |
| 3 (100 RF, 3 steps)     | 1,000     | 1.96            | 1.58                 | 0.03        | 1.70                 | 0.001      | 0.03       |
