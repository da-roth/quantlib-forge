# Local CI Test script (Docker/Linux)
...
Write-Host "  Local CI Test (Docker/Linux)" -ForegroundColor Cyan
...
echo "=== Building QuantLib with QuantLib-Forge (with tests) ==="
cmake -B build -S . \
  -G Ninja \
  -DCMAKE_BUILD_TYPE=Release \
...
if [ -n "$TEST_EXE" ]; then
    ...
    echo ""
    echo "============================================================="
    echo "  Tests Passed (Linux/Docker)"
    echo "============================================================="
else
